...
static void print_help()
{
    std::cout << "Scoreo2 is a high performance HTTP server based on Boost.Beast" << '\n'
              ...
              << "  -t, --thread: Specify thread numbers." << std::endl;
}
...
static int parse_args(int argc, char** argv)
{
    ...
    desc.add_options()
        ...
        ("thread,t", opts::value<int>()->default_value(1), "Specify thread numbers");
    ...
    SCOREO2_Config::instance()->threads = threads;
...
int main(int argc, char** argv)
{
    ...
    spdlog::debug("Starting {} ...", PROJECT_NAME);
